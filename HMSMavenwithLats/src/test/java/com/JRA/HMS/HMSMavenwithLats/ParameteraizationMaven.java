package com.JRA.HMS.HMSMavenwithLats;
...
public class ParameteraizationMaven {
		...
		public void login() throws InterruptedException
		{
			...
			driver.findElement(By.cssSelector("input.log[name=reset]")).click();
			Thread.sleep(3000);
			driver.findElement(By.cssSelector("input[name=username]")).sendKeys("user1");
			driver.findElement(By.cssSelector("input[name=password]")).sendKeys("user1");
